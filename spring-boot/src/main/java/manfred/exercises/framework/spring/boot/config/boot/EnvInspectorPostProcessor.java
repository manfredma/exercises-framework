 ...
 */
public class EnvInspectorPostProcessor implements EnvironmentPostProcessor {
    private static final Logger LOGGER = getLogger(EnvInspectorPostProcessor.class);
    ...
    public void postProcessEnvironment(
        ...
        System.out.printf("EnvInspectorPostProcessor: enviroment=%s, application=%s\n", environment, application);
